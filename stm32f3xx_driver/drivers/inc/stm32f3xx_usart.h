...
#ifndef INC_STM32F3XX_USART_H_
#define INC_STM32F3XX_USART_H_
...
/******************  Defines  ********************/
#define USART_WORDLENGHT_8BIT 0
#define USART_WORDLENGHT_9BIT 1
#define USART_WORDLENGHT_7BIT 2

#define USART_OVERSAMPLING_16 0
#define USART_OVERSAMPLING_8  1

#define USART_STOP_1BIT		  0
#define USART_STOP_0n5BIT	  1
#define USART_STOP_2BIT		  2
#define USART_STOP_1n5BIT	  3

#define USART_MODE_TXRX		  0
...
#define USART_BAUD_2400		   (uint32_t)2400
#define USART_BAUD_9600		   (uint32_t)9600
#define USART_BAUD_19200	   (uint32_t)19200
#define USART_BAUD_38400	   (uint32_t)38400
#define USART_BAUD_57600	   (uint32_t)57600
#define USART_BAUD_115200	   (uint32_t)115200


#define USART_FLAG_BUSY			(1<<16)
